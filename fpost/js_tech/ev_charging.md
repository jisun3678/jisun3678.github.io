...
- **목적**:
  ...
  - **완속 충전기**: 7kWh 및 11kWh 모델 개발. IEC 61851, SAE J1772 규격 충족을 통한 안정적 충전 제공.
...
- **기능 구현**:
  ...
  - **Pilot**:
    - IEC 61851, SAE J1772 규격에 따른 충전 드라이버 설계(ADC 기반 전압 감지, PWM 통신).  
  - **운영체제**:
